        ...
        <p className = 'pt-4 md:text-base text-sm'
          ...
          {/* Review and Rating */}
           <div className = 'flex items-center space-x-2 pt-3 pb-1 text-sm'>
                    ...
                    <div className = 'flex'>
                      {[...Array(5)].map((_,i)=>(
                        <img key = {i} src = {i < Math.floor(calculateRating(courseData)) ? assets.star : assets.star_blank} alt = 'Star Icon' className = 'w-3.5 h-3.5'/>
                      ))}
                    </div>
                    ...
                    <p className = 'text-sm'>Course By <span className = 'text-blue-600 underline'>Yandisa Ndubela</span></p>
